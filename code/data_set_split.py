...
def data_split():
    ...
    data_text=np.load('../data/idMatrix23.npy')
    # data_lable=pd.read_csv('../data/class_id.csv')
    # np.save('/home/zyy/桌面/class_id.npy',data_lable)
    data_lable=np.load('../data/class_id.npy',allow_pickle=True)
...
#定义词向量
def voca_vec():
    vec=np.load('../data/embedrealvec.npy',allow_pickle=True)
    return vec